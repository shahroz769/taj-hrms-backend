#!/usr/bin/env node
/**
 * Seed a test employee with Employee ID 14123 (for ZKTeco device matching).
 * Usage: node scripts/seedEmployee14123.mjs
 */
...
async function main() {
  ...
  console.log("\nConfigure ZKTeco device User ID = 14123 for this employee.");
